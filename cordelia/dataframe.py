...
def monthly_rents():
    ...
    # Plot the bar chart
    ax.bar(x_values, counts.values, color='#DCC6B6', label='Rents')

    # Plot the line chart
    ax.plot(x_values, counts.values, marker='o', linestyle='-', color='#00ff9d')
...
def top_customers():
    ...
    logging.debug(customer_rentals.head())
    ...
    top_customers_by_rentals.head(10).plot(kind='bar', y='Total Rentals', legend=True, ax=axs[0], color='#00ffff')
    ...
    top_customers_by_spending.head(10).plot(kind='bar', y='Total Spending', legend=True, ax=axs[1], color='#DCC6B6')
...
def costs_vs_earnings():
    ...
    # Plot earnings as a blue line
    ax.plot(x_values, df_costs_earnings['Earnings'], marker='o', color='#00ff9d', label='Earnings')

    # Plot maintenance costs as a red line
    ax.plot(x_values, df_costs_earnings['Maintenance Costs'], marker='o', color='#B07D47', label='Maintenance Costs')

    # Plot dress acquisition costs as a green line
    ax.plot(x_values, df_costs_earnings['Dress Acquisition Costs'], marker='o', color='#DCC6B6', label='Dress Acquisition Costs')
